...
public class reportePagada implements JRDataSource{
    ...
    private int index = -1; 
      ...
      public reportePagada(ArrayList<Jugada>jugadas){
    ...
    public static JRDataSource getDataSource(ArrayList<Jugada> jugadas){
        System.out.println("entro a getDataSource  Pagadas");
        return new reportePagada(jugadas);
    }
